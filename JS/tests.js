...
//     assert.isOk(o instanceof ForceConstructor);
//     assert.isOk(o.a === a);
//     assert.isOk('b' in o);
...
//     assert.isOk(func.myCall.toString().indexOf('.call') < 0);
//   });
//   it('Вызывает с правильным контекстом', function() {
...
//     assert.isOk(typeof throttle(function() {}, 0) === 'function');
//   });
...
//   });
//   it('Возвращает функцию', () => {
//     assert.isOk(typeof debounce(function() {}, 0) === 'function');
//   });
